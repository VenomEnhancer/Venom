...
class NormalCase:
    ...
    def set_args(self, parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
        ...
        parser.add_argument('--is_couple', type=lambda x: str(x) in ['True', 'true', '1'], default='False')
        parser.add_argument('--sim_beta', type=float, default=0.1, help='similarity beta of sim loss')
        parser.add_argument('--sim_p', type=float, default=1.0, help='probability of using sim loss')
        parser.add_argument('--sim_mode', type=str)
        parser.add_argument('--sim_lf', type=str, default='l1', help='loss function of couple attack, cos, at, l1, at_l1')
        parser.add_argument('--half_epochs', type=int, default=0, help='number of epochs to half train the model')
        parser.add_argument('--is_k', type=int, default=0, help='0 means without k')
        parser.add_argument('--test_path', type=str, default='', help='')
        parser.add_argument('--mtl', type=str, default='auto', help='way to add multi task loss, none means simple addition.(none, auto)')
        parser.add_argument('--auto_func', type=str, default='func2', help='func1, func2, cos')
        parser.add_argument('--auto_norm', type=str, default='add', help='none, add')
        parser.add_argument('--auto_beta', type=float,default=0, help='lambda of auto beta')
        parser.add_argument('--loss_log', type=lambda x: str(x) in ['True', 'true', '1'],default='False')
